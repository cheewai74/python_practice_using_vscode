# 
# 1. Create a folder C:\work\mysql-sqlalchemy-csv-workspace
# 2. python -m venv C:\work\mysql-sqlalchemy-csv-workspace
# 3. Copy python file to C:\work\mysql-sqlalchemy-csv-workspace
# 4. Copy landon.csv to C:\work\mysql-sqlalchemy-csv-workspace
#
# pip install:
# pip install pandas
...
engine = create_engine('mysql+mysqlconnector://root:@localhost:3306/landon', 
                       echo=True)
